...
import { DocumentCategory as DocCategory, DocumentItem } from '../../lib/firebaseFirestore'
import FileUpload from '../ui/FileUpload'
import Card from '../ui/Card'

interface CustomDocumentCategoryProps {
...
const CustomDocumentCategory: React.FC<CustomDocumentCategoryProps> = ({
  category,
  uploadedDocuments,
  onFileUpload,
  onFileRemove,
            ...
            return (
              <div key={document.id} className="border rounded-lg p-4">
                ...
                <FileUpload
                  ...
                  currentFile={isUploaded ? uploadedDoc.original_filename || uploadedDoc.file_url?.split('/').pop() : undefined}
                  label=""
...
export default CustomDocumentCategory